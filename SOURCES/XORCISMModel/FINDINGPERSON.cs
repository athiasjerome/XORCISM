...
namespace XORCISMModel
{
    ...
    public partial class FINDINGPERSON
    {
        public int FindingPersonID { get; set; }
        public string FindingPersonGUID { get; set; }
        public Nullable<int> FindingID { get; set; }
        public string FindingGUID { get; set; }
        public string FindingPersonRelationship { get; set; }
        public string FindingPersonDescription { get; set; }
