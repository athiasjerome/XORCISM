...
namespace XORCISMModel
{
    ...
    public partial class SECURITYCONTROLTYPE
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public SECURITYCONTROLTYPE()
        {
            this.SECURITYCONTROL = new HashSet<SECURITYCONTROL>();
            this.SECURITYCONTROLTYPETAG = new HashSet<SECURITYCONTROLTYPETAG>();
        }
    
        public int SecurityControlTypeID { get; set; }
        public string SecurityControlTypeName { get; set; }
        public string SecurityControlTypeDescription { get; set; }
