...
namespace XORCISMModel
{
    ...
    {
        public int PlatformMappingID { get; set; }
        public Nullable<int> PlaformRefID { get; set; }
        public string PlatformRefGUID { get; set; }
        public string PlatformRelationship { get; set; }
        public Nullable<int> PlatformSubjectID { get; set; }
        public string PlatformSubjectGUID { get; set; }
