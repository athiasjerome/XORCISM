...
namespace XORCISMModel
{
    ...
    public partial class CPEFILELIST
    {
        public int CPEFileListID { get; set; }
        public Nullable<int> CPEID { get; set; }
        public string CPEName { get; set; }
        public string CPEFileListRelationship { get; set; }
        public string CPEFileListDescription { get; set; }
