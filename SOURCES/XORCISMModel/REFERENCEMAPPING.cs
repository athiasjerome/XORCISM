...
namespace XORCISMModel
{
    ...
    {
        public int ReferenceMappingID { get; set; }
        public Nullable<int> ReferenceRefID { get; set; }
        public string RelationShipText { get; set; }
        public Nullable<int> ReferenceSubjectID { get; set; }
        public string ReferenceMappingDescription { get; set; }
