...
namespace XORCISMModel
{
    ...
    public partial class CWEMODEOFINTRODUCTION
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public CWEMODEOFINTRODUCTION()
        {
            this.CWEMODEOFINTRODUCTIONTAG = new HashSet<CWEMODEOFINTRODUCTIONTAG>();
        }
    
        public int CWEModeOfIntroductionID { get; set; }
        public string CWEID { get; set; }
        public string ModeOfIntroductionDescription { get; set; }
