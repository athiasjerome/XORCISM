...
namespace XORCISMModel
{
    ...
    public partial class PACKAGINGENCRYPTION
    {
        public int PackagingEncryptionID { get; set; }
        public string PackagingEncryptionGUID { get; set; }
        public int PackagingID { get; set; }
        public string PackagingGUID { get; set; }
        public int EncryptionID { get; set; }
        public string EncryptionGUID { get; set; }
        public int LayerOrder { get; set; }
        public string encryption_key { get; set; }
        public string encryption_key_ref { get; set; }
        public string PackagingEncryptionDescription { get; set; }
