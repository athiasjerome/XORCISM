...
namespace XORCISMModel
{
    ...
    public partial class ACCESSEDDIRECTORYLIST
    {
        public int AccessedDirectoryListID { get; set; }
        public string AccessedDirectoryListGUID { get; set; }
        public string AccessedDirectoryListName { get; set; }
