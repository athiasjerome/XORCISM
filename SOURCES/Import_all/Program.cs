...
namespace Import_all
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region CVErecent
            sDownloadFileURL = "http://static.nvd.nist.gov/feeds/xml/cve/nvdcve-2.0-recent.xml.zip";    //HARDCODED
            sDownloadFileName = "nvdcve-2.0-recent.xml.zip";    //Hardcoded
            ...
            try
            {
                ...
                webRequest.UserAgent = "XORCISM"; //HARDCODED
            ...
            if (fileSizeRemote == fileSizeLocal)
            {
                //Same FileSizes: no need to redownload
            }
            else
            {
                //Download the file
            ...
            {
                //TODO Hardcoded
                //sDownloadFileName = "nvdcve-2.0-recent.xml.zip";
                ZipArchive archive = ZipFile.Open(@"C:\nvdcve\" + sDownloadFileName, ZipArchiveMode.Read);  //HARDCODED
                //archive.ExtractToDirectory(@"C:\nvdcve\");
                foreach (ZipArchiveEntry file in archive.Entries)
                {
                    string completeFileName = Path.Combine(@"C:\nvdcve\", file.FullName);   //HARDCODED
                    if (file.Name == "")
            ...
            catch (Exception exUnzipRecentCVE)
            {
                Console.WriteLine("DEBUG " + DateTimeOffset.Now);
                Console.WriteLine("Exception: exUnzipRecentCVE: " + exUnzipRecentCVE.Message + " " + exUnzipRecentCVE.InnerException);
            ...
            #region CVEmodified
            sDownloadFileURL = "http://static.nvd.nist.gov/feeds/xml/cve/nvdcve-2.0-modified.xml.zip";  //HARDCODED
            sDownloadFileName = "nvdcve-2.0-modified.xml.zip";  //Hardcoded
            ...
            {
                //TODO Hardcoded
                //sDownloadFileName = "nvdcve-2.0-modified.xml.zip";
                ZipArchive archive = ZipFile.Open(@"C:\nvdcve\" + sDownloadFileName, ZipArchiveMode.Read);  //HARDCODED
                //archive.ExtractToDirectory(@"C:\nvdcve\");
                foreach (ZipArchiveEntry file in archive.Entries)
                {
            ...
            catch (Exception exUnzipModifiedCVE)
            {
                Console.WriteLine("DEBUG " + DateTimeOffset.Now);
                Console.WriteLine("Exception: exUnzipModifiedCVE: " + exUnzipModifiedCVE.Message + " " + exUnzipModifiedCVE.InnerException);
                //The file ? already exists.
            }
            ...
            for (int iYear=iCurrentYear;iYear>2001;iYear--)
            {
                ...
                sDownloadFileURL = "http://static.nvd.nist.gov/feeds/xml/cve/nvdcve-2.0-" + iYear + ".xml.zip"; //HARDCODED
                sDownloadFileName = "nvdcve-2.0-" + iYear + ".xml.zip"; //Hardcoded
                sDownloadLocalFile = "nvdcve-2.0-" + iYear + ".xml";
                ...
                {
                    Console.WriteLine("DEBUG "+DateTimeOffset.Now);
                    Console.WriteLine("DEBUG NOT IMPORTING " + sDownloadFileName +" (same file size)");
                }
                else
                {
                    //Download the file
                ...
                {
                    //TODO Hardcoded
                    //sDownloadFileName = "nvdcve-2.0-XXXX.xml.zip";
                    ZipArchive archive = ZipFile.Open(@"C:\nvdcve\" + sDownloadFileName, ZipArchiveMode.Read);  //HARDCODED
                    //archive.ExtractToDirectory(@"C:\nvdcve\");
                    foreach (ZipArchiveEntry file in archive.Entries)
                    {
                ...
                catch (Exception exUnzipCVE)
                {
                    Console.WriteLine("DEBUG " + DateTimeOffset.Now);
                    Console.WriteLine("Exception: exUnzipCVE: " + exUnzipCVE.Message + " " + exUnzipCVE.InnerException);
                    //The file ? already exists.
                }
                ...
                if (fileSizeRemote == fileSizeLocal)// || iErrorTimeout)
                {
                    Console.WriteLine("DEBUG NOT IMPORTING CVE because same Files Size");
                }
                else
                {
                    try
        ...
        static private void Import_metasploit()
        {
            ...
            //Regex myRegexCVE = new Regex("'CVE', '[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]'");
            Regex myRegexCVE = new Regex(@"'CVE', '[0-9][0-9][0-9][0-9]-\d+'");
                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                        else
                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                else
                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                                                                                        myRegex = new Regex("oracle.com/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                        strTemp = myRegex.Match(theurl).ToString();
                                                                                                                                                                                                                                                                                                                                                                        //http://oracle.com/technetwork/topics/security/cpuapr2013-1899555.html
                                                                                                                                                                                                                                                                                                                                                                        if (strTemp != "")
                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                            mySource = "ORACLE";
                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                            myRegex = new Regex("theregister.co.uk/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                            strTemp = myRegex.Match(theurl).ToString();
                                                                                                                                                                                                                                                                                                                                                                            //http://theregister.co.uk/2013/07/09/hp_storage_more_possible_backdoors/
                                                                                                                                                                                                                                                                                                                                                                            if (strTemp != "")
                                                                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                                                                mySource = "The Register";
                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                            else
                                                                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                                                                myRegex = new Regex("zerodayinitiative.com/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                                strTemp = myRegex.Match(theurl).ToString();
                                                                                                                                                                                                                                                                                                                                                                                //http://zerodayinitiative.com/advisories/ZDI-14-008/
                                                                                                                                                                                                                                                                                                                                                                                if (strTemp != "")
                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                    mySource = "ZDI";
                                                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                    myRegex = new Regex("arubanetworks.com/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                                    strTemp = myRegex.Match(theurl).ToString();
                                                                                                                                                                                                                                                                                                                                                                                    //http://arubanetworks.com/support/alerts/aid-042213.asc
                                                                                                                                                                                                                                                                                                                                                                                    if (strTemp != "")
                                                                                                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                                                                                                        mySource = "ARUBA";
                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                    else
                                                                                                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                                            myRegex = new Regex("isc.org/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                                            strTemp = myRegex.Match(theurl).ToString();
                                                                                                                                                                                                                                                                                                                                                                                            //http://isc.org/software/bind/advisories/cve-2013-2266
                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                                                                                myRegex = new Regex("asterisk.org/[^<>]*");
                                                                                                                                                                                                                                                                                                                                                                                                strTemp = myRegex.Match(theurl).ToString();
                    ...
                    switch (sInfoToSearch)
                    {
                        ...
                        case "references":
                            if (lineOSVDB != "</li>")
                            {
                                ...
                                //Metasploit URL:
                                #region osvdbcve
                                //myRegex = new Regex("CVE-[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]");
                                Regex myRegexCVE = new Regex(@"CVE-(19|20)\d\d-(0\d{3}|[1-9]\d{3,})");
                                //https://cve.mitre.org/cve/identifiers/tech-guidance.html

                                strTemp = myRegexCVE.Match(lineOSVDB).ToString();
                                if (strTemp == "")
                                {
                                    //We do another test to find a CVE
                                    //myRegex = new Regex(@"cvename.cgi\?name=[0-9][0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]");
                                    myRegex = new Regex(@"cvename.cgi\?name=[0-9][0-9][0-9][0-9]-\d+");
