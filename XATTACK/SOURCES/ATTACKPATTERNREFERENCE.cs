...
namespace XATTACKModel
{
    ...
    public partial class ATTACKPATTERNREFERENCE
    {
        public int AttackPatternReferenceID { get; set; }
        public string AttackPatternReferenceGUID { get; set; }
        ...
        public string Local_Reference_ID { get; set; }
