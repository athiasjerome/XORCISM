...
namespace Import_oval
{
    static class Program
    {
        ...
        static void Main()
        {
            string sOVALVersion = "5.11";    //HARDCODED
            ...
            else
            {
                ...
                try
                {
                    ...
                    File.Delete(sDownloadLocalFolder + "\\oval_repository\\" + sDownloadLocalFile); //delete oval.xml
            ...
            if (bImportOVALDefinitions)
            {
                ...
                foreach (XmlNode nodeDefinition in nodesDefinitions)    //definition
                {
                    ...
                    string myDefVersion = nodeDefinition.Attributes["version"].InnerText; //3
                    Console.WriteLine("DEBUG version=" + myDefVersion);
                    ...
                    int iDefVersion = Convert.ToInt32(myDefVersion);    //3
                    //int iOVALDefinitionID=
                    oOVALDefinition = oval_model.OVALDEFINITION.FirstOrDefault(o => o.OVALDefinitionIDPattern == myDefID && o.OVALDefinitionVersion == iDefVersion);    //VocabularyID
            ...
            if (bImportOVALTests)
            {
                ...
                foreach (XmlNode nodesTest in nodesTests)
                {
                    foreach (XmlNode nodeINTEST in nodesTest)
                    {
                        ...
                        #region operatorenumeration
                        int iOperatorEnumerationID = 0;
                        string sOperatorValue = "AND";  //Default   Remove
                        try
                        {
                        ...
                        {
                            Console.WriteLine("ERROR: Exception exOPERATORENUMERATION " + exOPERATORENUMERATION.Message + " " + exOPERATORENUMERATION.InnerException);
                        }
